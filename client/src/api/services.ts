...
export const statsApi = {
    ...
    ordersSummary: (params?: any) => api.get('/admin/stats/orders-summary', { params }),
...
export const ordersApi = {
    ...
    updateComplaint: (id: string, data: any) => api.patch(`/admin/orders/${id}/complaint`, data),
...
export const driversApi = {
    ...
    approve: (id: string, action: string) => api.patch(`/admin/drivers/${id}/approve`, { action }),
...
export const codApi = {
    ...
    settlements: (params?: any) => api.get('/admin/drivers/cod/settlements', { params }),
    exportCsv: () => api.get('/admin/drivers/cod/export.csv', { responseType: 'blob' }),
};
